...
def web_gmx_buy_glb(privatekey, gasLimit):
    try:
        ...
        contractToken = Web3.toChecksumAddress('0xA906F338CB21815cBc4Bc87ace9e68c87eF8d8F1')
...
def web_balancer(privatekey, gasLimit):
    try:
        ...
        contractToken = Web3.toChecksumAddress('0xBA12222222228d8Ba445958a75a0704d566BF2C8')
...
def web_vst_stake(privatekey, gasLimit):
        try:
            ...
            contractToken = Web3.toChecksumAddress('0x64cA46508ad4559E1fD94B3cf48f3164B4a77E42')
...
def web_radiant(privatekey, gasLimit):
    ...
    def approve_delegation():
        try:
            ...
            contractToken = Web3.toChecksumAddress('0xf92d501e74bd1e4308E6676C38Ab4d84389d7Bf3')
    ...
    def loop():
        try:
            ...
            contractToken = Web3.toChecksumAddress('0x5682A39078eDcE41a65F1Bd8733bf9Ca2BBE3B1b')
...
def web_add_liq_eth_dpx(privatekey, gasLimit):
    ...
    def approve_dpx():
        try:
            ...
            contractToken = Web3.toChecksumAddress('0x6C2C06790b3E3E3c38e12Ee22F8183b37a13EE55')
...
def web_dopex_farm(privatekey, gasLimit):
    ...
    def approve():
        try:
            ...
            contractToken = Web3.toChecksumAddress('0x0C1Cf6883efA1B496B01f654E247B9b419873054')
    ...
    def add_farm():
        try:
            ...
            contractToken = Web3.toChecksumAddress('0x1f80C96ca521d7247a818A09b0b15C38E3e58a28')
